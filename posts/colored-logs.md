...
The rest of this post can be modified to fit your chosen way of
differentiating. I emphasize how the colors change between the two equations by
...
the expression `\(\log_{3}(81)\)` asks the question “3 to what power is 81”
just like `\(81÷3\)` asks “3 times what is 81” and `\(\sqrt[3]{81}\)` asks
“what number to the 3rd power is 81”.
...
comes after superficial symbol shuffling. Unfortunately,  I haven”t had time in
my college-level courses, with about 48 contact hours, to delve into helping my
...
question “3 to what power gives the answer 81”, and the value of this
expression is the answer to its question. Another way I stress mastery is
...
Substituting away the variables in the third equation using the other
equations, we see
