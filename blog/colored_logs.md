...
`\[\begin{align*}
  {\color{red}f}({\color{blue}x}) & = {\color{green}y} &
    âŸ· {\color{red}f^{-1}}({\color{green}y}) & = {\color{blue}x} \\
  {\color{red}b}^{\color{blue}x} & = {\color{green}y} &
    âŸ· {\color{red}\log_{b}}({\color{green}y}) & = {\color{blue}x}
\end{align*}\]`
...
`\[\begin{align*}
  ...
  \colorbox{red}{ }\left(\colorbox{blue}{ }\right)
    = \colorbox{green}{ } &
    âŸ· & \colorbox{red}{ }\left(\colorbox{green}{ }\right)
    = \colorbox{blue}{ }
\end{align*}\]`
...
>  Whatever exponent of `\(b\)` yields `\(u â‹… v\)` is the same as
...
> `\(z\)`, the exponent of `\(b\)` which yields `\(u â‹… v\)`, is the same as
...
we see
`\({\color{red}b^{x + y}} = {\color{blue}b^{x}} â‹… {\color{green}b^{y}}\)`.
